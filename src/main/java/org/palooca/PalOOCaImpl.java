              ...
              XPalOOCa
{
    ...
    private IElement getElement(String servdb, String dimensionName,
        ...
        return dimension.getElementByName(elementName,false);
    }
...
//    }
    ...
    public String PALO_EFIRST(String servdb, String dimensionName) {
       return PALO_ENAME(servdb, dimensionName, 1, null, null, null);
    }
...
//            return strs;
    ...
    public Object PALO_EINDENT(String servdb, String dimensionName, String elementName){
        try {
            ...
            return PaloLibUtil.getElementDepth(element) + 1;
    ...
    public Object PALO_ELEVEL(String servdb, String dimensionName, String elementName) {
        try {
            ...
            return PaloLibUtil.getElementDepth(element);
    ...
    public Object PALO_ETOPLEVEL(String servdb, String dimensionName) {
        try {
            ...
            return dimension.getDimensionInfo().getMaximumLevel();
        } catch (Exception e) {
            return null;
        }
    }
    ...
    public String[][] PALO_DATABASE_LIST_DIMENSIONS(String servdb) {
        try {
            ...
            ArrayList<String> validDimensions = new ArrayList<>();
            for (IDimension dimension : dimensions)
                if (dimension.getType().equals(IDimension.DimensionType.DIMENSION_NORMAL))
                    validDimensions.add(dimension.getName());
