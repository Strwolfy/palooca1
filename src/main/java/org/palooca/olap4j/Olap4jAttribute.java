...
public class Olap4jAttribute implements IAttribute {

	private Property property;
	
	public Olap4jAttribute(Property property) {
	...
	public void rename(String newname) throws PaloJException {
		throw new PaloJException("Renaming attributes not supported by OLAP4j provider.");
	}
